...
toc = Seurat::Read10X(data.dir = "/cluster/tufts/chinlab/single_nuclei_taz_mice/TAZ_MICE_COUNT_MATRICES/mouse_5300_counts/outs/filtered_feature_bc_matrix")
tod = Seurat::Read10X(data.dir = "/cluster/tufts/chinlab/single_nuclei_taz_mice/TAZ_MICE_COUNT_MATRICES/mouse_5300_counts/outs/raw_feature_bc_matrix")
...
clusters<-read.csv(file = "/cluster/tufts/chinlab/single_nuclei_taz_mice/TAZ_MICE_COUNT_MATRICES/mouse_5300_counts/outs/analysis/clustering/graphclust/clusters.csv")
...
dimension_reduction<-read.csv(file = "/cluster/tufts/chinlab/single_nuclei_taz_mice/TAZ_MICE_COUNT_MATRICES/mouse_5300_counts/outs/analysis/umap/2_components/projection.csv")
...
plot = dd %>%ggplot(aes(x = UMAP.1, y = UMAP.2, color = factor(Cluster),))+
  geom_point() + labs(x = "UMAP1", y = "UMAP2", subtitle = "SoupX m5300: UMAP Plot ")
plot
ggsave("images/m5300_SoupXPlot_UMAP.png")
...
gg = ggplot(dd, aes(UMAP.1, UMAP.2)) + geom_point(aes(colour = Mybpc3 > 0)) + labs(x = "UMAP1", y = "UMAP2", subtitle = "SoupX m5300: Cells with Mybpc3 Expression ")
plot(gg)
ggsave(filename = "images/m5300_SoupXPlot_UMAP_Mybpc3.png")
...
gg = plotMarkerMap(sc, "Mybpc3") + labs(x = "UMAP1", y = "UMAP2", subtitle = "SoupX m5300: Cells with Mybpc3 Expression Enriched Over Background (Observed/Expected)")
plot(gg)
ggsave(filename = "images/m5300_SoupXPlot_UMAP_Mybpc3_Observed.Expected.Ratio.png")
...
sc = setContaminationFraction(sc, contamination_faction, forceAccept = TRUE)

#Correct Expression Profile
out = adjustCounts(sc, roundToInt=TRUE)
saveRDS(out, file = "out/m5300_SoupXObject_Corrected_Matrix.rds" )
################################################################################

################################################################################
#Plot Fraction of Mybpc3 Expression Determined to be Soup 
plotChangeMap(sc, out, "Mybpc3")+labs(subtitle = "m5300")
ggsave("images/m5300_SoupXPlot_Mybpc3.Soup.Correction.png")
